...
- The top left panel is where you write and run code and where you view your datasets. You can open up a new scripting window by clicking File > New File > R Script (or 'Ctrl Shift n'). You can save these as '.R' files. How you actually go about running code that you have written here is covered further on under '[How do I run code?](#how_do_i_run_code?)'  To view datasets in this window you can click them in the 'Environment' panel (top right) or run `View(dataset_name)`. 
